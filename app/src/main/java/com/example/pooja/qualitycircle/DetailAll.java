 ...
 */
public class DetailAll extends Fragment {
    private TableLayout tableLayout;
    private static  final String DETAIL_URL="http://lntebgqc.pe.hu/detailAll.php";
    public DetailAll() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tableLayout=(TableLayout) view.findViewById(R.id.tabledetail);
